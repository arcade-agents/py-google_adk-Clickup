...
"""
ENFORCE_HUMAN_CONFIRMATION = ['Clickup_CreateTask', 'Clickup_CreateTaskComment', 'Clickup_CreateTaskCommentReply', 'Clickup_UpdateTask', 'Clickup_UpdateTaskAssignees', 'Clickup_UpdateTaskComment']